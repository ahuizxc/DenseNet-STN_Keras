...
from model.spatial_transformer_network import SpatialTransformer
...
def createSTNDenseNet(nb_classes, img_dim, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=16, dropout_rate=None,
    ...
    weights = [W, b.flatten()]
    locnet = Sequential()
    locnet.add(MaxPooling2D(pool_size=(2,2), input_shape=img_dim))
